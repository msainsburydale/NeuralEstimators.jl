...
Note that one may also train the estimator using fixed parameter sets and fixed training data (as described in [`train`](@ref)), by passing parameter or data instances:
