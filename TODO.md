...
### Performance
- 🟡 Reactant support for [DeepSet](https://msainsburydale.github.io/NeuralEstimators.jl/dev/API/architectures#Modules). Reactant probably requires arrays of fixed dimension (might need padding + masking).
