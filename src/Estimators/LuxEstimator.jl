...
for f in (:estimate, :infer, :summarystatistics, :assess, :sampleposterior, :spikeprobability, :bootstrap, :interval, :quantiles, :posteriormean, :posteriormedian, :posteriorquantile, :logratio, :_logdensity)
