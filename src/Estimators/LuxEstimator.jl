...
for f in (:estimate, :summarystatistics, :assess, :sampleposterior, :spikeprobability, :bootstrap, :interval, :quantiles, :posteriormean, :posteriormedian, :posteriorquantile, :logratio, :logposterior, :_logdensity)
